...
# MeteoMaps Directory Structure

## CET (Climate Explorer)
The default landing page, which displays a climate or temperature data viewer for browsing historical records. This is likely focused on Central England Temperature (CET) data or similar long-running datasets.
